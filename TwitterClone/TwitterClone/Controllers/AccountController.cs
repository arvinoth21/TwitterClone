...
namespace TwitterClone.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            TwitterCloneRepository _twitterCloneRepository = new TwitterCloneRepository();
            var email = _twitterCloneRepository.GetEmail(model.UserId);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                personModel.Joined = model.Joined;
                personModel.Email = model.Email;
                personModel.Password = model.Password;

                var twit = _twitterCloneRepository.RegisterUser(personModel);
                if (twit == "Success")
                {
                    Session["UserId"] = model.UserId;
